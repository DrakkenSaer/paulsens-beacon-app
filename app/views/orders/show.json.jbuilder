...
json.promotions @order.promotions, :id, :promotional_type, :promotional_id, :title, :desription, :code, :redeem_count, :daily_deal, :featured, :cost, :expiration, :created_at, :updated_at
